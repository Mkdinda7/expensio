            ...
            <div className="col-lg-6 login-form-area">
              ...
              <form className="login-form" onSubmit={handleSubmit}>
                ...
                <div className="mb-2 form-check">
                  <input type="checkbox" className="form-check-input border border-primary rounded p-2" id="rememberMe" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} />
                  <label className="form-check-label fw-bold" style={{fontSize: "15px", marginLeft: "10px"}} htmlFor="rememberMe">Remember me</label>
                </div>
